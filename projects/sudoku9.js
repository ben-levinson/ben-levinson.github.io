...
var cellSize = 50;//px
var selection = 9; //9 for regular sudoku, 16 for hexadecimal sudoku
...
{
    //setup for jekyll
    var sudoku9_canvasDiv = document.getElementById("sudoku9")
    var sudoku9_divWidth = document.getElementById("sudoku9").clientWidth;
    var sudoku9_sketchCanvas = createCanvas(sudoku9_divWidth,452);
    sudoku9_sketchCanvas.parent("sudoku9");
